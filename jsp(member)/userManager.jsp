	...
	<header>
		...
		<div id="wrap" align="center">
			...
			<form action="BookServlet" method="post" name="frm">
				<input type="hidden" name="command" value="member_info"> <input
					type="hidden" name="id" value="${mVo.id}">
				<div id="userbox">
		...
		<tr>
			<td>아이디 </td>
			<td> <input type="text" name="id" size="20" value="${mVo.id}" readonly></td>
		</tr>
		<tr>
			<td>암 &nbsp; 호 </td>
			<td> <input type="password" name="pass" size="20" value="${mVo.pass}">*</td>
		</tr>
		<tr height="30">
